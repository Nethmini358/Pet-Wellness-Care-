...
class complete_activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.complete_activity) // connects to complete_activity.xml

        // Find button by its ID
        val btn_switch2 : Button = findViewById(R.id.btn_switch2)
